...
for(storey.lambda in seq(0,1,0.05)){
  ...
  p1.Null <- runif(n.test*true.pi0, min=0.1,max=0.9)
  p2.Null <- p1.Null
  p1.Nonnull <- 0.5 * runif(n.test*true.pi1,min=0.1,max=0.9) 
  p2.Nonnull <- p1.Nonnull + runif(n.test*true.pi1,min=0.2,max=0.5)
  ...
  print(mse)
  mse.setup1.20.0.9 = c(mse.setup1.20.0.9, mse)
}
